...
public class ListarUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListarUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DPI", "NIT", "Nombre", "Apellido", "Direccion", "Telefono", "Usuario", "Contraseña", "Rol", "id"
            }
        ) {
        ...
        if (tblListarUsuarios.getColumnModel().getColumnCount() > 0) {
            ...
            tblListarUsuarios.getColumnModel().getColumn(5).setPreferredWidth(150);
            tblListarUsuarios.getColumnModel().getColumn(6).setPreferredWidth(150);
            tblListarUsuarios.getColumnModel().getColumn(7).setPreferredWidth(400);
            tblListarUsuarios.getColumnModel().getColumn(8).setPreferredWidth(150);
            tblListarUsuarios.getColumnModel().getColumn(9).setResizable(false);
        }
    ...
    for(Usuario p : usuario){
        ...
        Object newRow[] = {p.getDpi(),p.getNit(),p.getNombre(),p.getApellido(),p.getDireccion(),p.getTelefono(),p.getUsuario(),p.getContrasena(),rol,p.getId()};
        model.addRow(newRow);
        
    }
        //Ocultar id
        TableColumn columna2 = tblListarUsuarios.getColumnModel().getColumn(9);
    ...
    String telefono = (String) tblListarUsuarios.getValueAt(fila,5);
    String usuario = (String) tblListarUsuarios.getValueAt(fila,6); 
    String contrasena = (String) tblListarUsuarios.getValueAt(fila,7);
    String rol = (String) tblListarUsuarios.getValueAt(fila,8);
    String id = (String) tblListarUsuarios.getValueAt(fila,9);
    
    FormEditarUsuario.setDatosUsuario(dpi,nit,nombre,apellido,direccion,telefono,usuario,contrasena,rol,id);  
    }
