   ...
   ProductoJpaController ProductoEntityManager;
    ...
    private void initComponents() {
        ...
        if (tblListarProductos.getColumnModel().getColumnCount() > 0) {
            ...
            tblListarProductos.getColumnModel().getColumn(4).setPreferredWidth(180);
            tblListarProductos.getColumnModel().getColumn(5).setPreferredWidth(180);
            tblListarProductos.getColumnModel().getColumn(6).setPreferredWidth(100);
        }
    ...
    Double precioCompra = Double.valueOf(tblListarProductos.getValueAt(fila,4).toString());
    Double precioVenta = Double.valueOf(tblListarProductos.getValueAt(fila,5).toString());
    Integer stock = Integer.valueOf(tblListarProductos.getValueAt(fila,6).toString());
    
    FormEditarProducto.setDatosProducto(codigo,nombre,categoria,unidad,precioCompra,precioVenta,stock);
    }
