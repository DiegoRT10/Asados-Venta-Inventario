...
public class ListarVentas extends javax.swing.JFrame {
    ...
    for(Venta v : venta){
        conTotal += Double.parseDouble(v.getTotal().toString());
        Object newRow[] = {v.getId(),v.getIdUsuario(),v.getIdCliente(),v.getIdUsuario().getNombre(),v.getIdCliente().getNombre(), sdf.format(v.getFechaVenta()), v.getTotal()};
        model.addRow(newRow);
    }
        //Ocultar id
