...
public class ListarClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListarClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIT", "Nombre", "Apellidos", "Direccion", "Telefono", "id"
            }
        ) {
        ...
        if (tblListarClientes.getColumnModel().getColumnCount() > 0) {
            tblListarClientes.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblListarClientes.getColumnModel().getColumn(1).setPreferredWidth(150);
            tblListarClientes.getColumnModel().getColumn(2).setPreferredWidth(150);
            tblListarClientes.getColumnModel().getColumn(3).setPreferredWidth(200);
            tblListarClientes.getColumnModel().getColumn(4).setPreferredWidth(150);
            tblListarClientes.getColumnModel().getColumn(5).setResizable(false);
        }
    ...
    for(Cliente p : cliente){
        Object newRow[] = {p.getNit(),p.getNombre(),p.getApellidos(),p.getDireccion(),p.getTelefono(),p.getId()};
        model.addRow(newRow);
    }
        //Ocultar id
        TableColumn columna2 = tblListarClientes.getColumnModel().getColumn(5);
    ...
    String nit = (String) tblListarClientes.getValueAt(fila,0);
    String nombre = (String) tblListarClientes.getValueAt(fila,1);
    String apellido = (String) tblListarClientes.getValueAt(fila,2);
    String direccion = (String) tblListarClientes.getValueAt(fila,3);
    String telefono = (String) tblListarClientes.getValueAt(fila,4);
    String id = (String) tblListarClientes.getValueAt(fila,5);
    
    FormEditarCliente.setDatosCliente(nit,nombre,apellido,direccion,telefono,id);
    }
