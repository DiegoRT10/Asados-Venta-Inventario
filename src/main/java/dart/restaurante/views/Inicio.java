...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblConsultaMenus = new javax.swing.JLabel();
        ...
        lblinfoVender4 = new javax.swing.JLabel();
        lblTituloVender4 = new javax.swing.JLabel();
        lblImgVender4 = new javax.swing.JLabel();
        ...
        jLabel12.setFont(new java.awt.Font("Brush Script MT", 1, 36)); // NOI18N
        jLabel12.setText("Asados");
        pnlFondo.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 20, 100, 50));
        ...
        pnlSeccionInventario.add(lblinfoConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, 260, 150));
        ...
        pnlSeccionInventario.add(lblImgConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 290, 140));
        ...
        lblTituloConsulta.setText("Consulta Productos");
        lblTituloConsulta.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionInventario.add(lblTituloConsulta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, -1, -1));

        lblConsultaProductos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/separador.png"))); // NOI18N
        lblConsultaProductos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblConsultaProductos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblConsultaProductosMouseClicked(evt);
            }
        });
        pnlSeccionInventario.add(lblConsultaProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 316, 371));
        ...
        lblTituloConsulta1.setText("Consulta Menus");
        lblTituloConsulta1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionInventario.add(lblTituloConsulta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 320, -1, -1));
        ...
        pnlSeccionInventario.add(lblinfoConsulta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 350, 260, 150));
        ...
        pnlSeccionInventario.add(lblImgConsulta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 160, 290, 140));

        lblConsultaMenus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/separador.png"))); // NOI18N
        lblConsultaMenus.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblConsultaMenus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblConsultaMenusMouseClicked(evt);
            }
        });
        pnlSeccionInventario.add(lblConsultaMenus, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 150, 316, 371));
        ...
        lblImgVender.setIcon(new javax.swing.ImageIcon(getClass().getResource("/venta-comida.png"))); // NOI18N
        lblImgVender.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionServicios.add(lblImgVender, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 250, 110));
        ...
        lblImgComprar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/compra-comida.png"))); // NOI18N
        lblImgComprar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionServicios.add(lblImgComprar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 160, 250, 110));
        ...
        lblImgKardex.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resumen-ventas.png"))); // NOI18N
        ...
        lblResumenVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/separador.png"))); // NOI18N
        lblResumenVenta.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblResumenVenta.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblResumenVentaMouseClicked(evt);
            }
        });
        pnlSeccionServicios.add(lblResumenVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 150, 270, 340));
        ...
        pnlSeccionFacturacion.add(lblImgVender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 180, 110));
        ...
        pnlSeccionFacturacion.add(lblTituloVender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 290, 90, -1));
        ...
        pnlSeccionFacturacion.add(lblinfoVender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 320, 140, 160));
        ...
        pnlSeccionFacturacion.add(lblApertura, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 200, 340));
        ...
        pnlSeccionFacturacion.add(lblImgVender2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 170, 180, 110));
        ...
        pnlSeccionFacturacion.add(lblTituloVender2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 60, -1));
        ...
        pnlSeccionFacturacion.add(lblinfoVender2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 330, 140, 160));
        ...
        pnlSeccionFacturacion.add(lblCierre, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 160, 200, 340));
        ...
        pnlSeccionFacturacion.add(lblImgVender3, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 170, 180, 110));
        ...
        lblTituloVender3.setText("Ventas/Compras");
        lblTituloVender3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionFacturacion.add(lblTituloVender3, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 290, 160, -1));
        ...
        pnlSeccionFacturacion.add(lblinfoVender3, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 340, 140, 160));
        ...
        pnlSeccionFacturacion.add(lblResumen, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 160, 200, 340));

        lblinfoVender4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lblinfoVender4.setForeground(new java.awt.Color(153, 153, 153));
        lblinfoVender4.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionFacturacion.add(lblinfoVender4, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 330, 140, 160));

        lblTituloVender4.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblTituloVender4.setForeground(new java.awt.Color(153, 153, 153));
        lblTituloVender4.setText("Gastos");
        lblTituloVender4.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionFacturacion.add(lblTituloVender4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 290, 70, -1));

        lblImgVender4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/listar.png"))); // NOI18N
        lblImgVender4.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        pnlSeccionFacturacion.add(lblImgVender4, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 170, 180, 110));

        lblCierre1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/separador.png"))); // NOI18N
        lblCierre1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblCierre1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblCierre1MouseClicked(evt);
            }
        });
        pnlSeccionFacturacion.add(lblCierre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 160, 200, 340));
...
//        this.dispose();
    ...
    private void lblConsultaProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblConsultaProductosMouseClicked
    ListarInventario li = new ListarInventario();
    li.setVisible(true);
    this.dispose();
    }//GEN-LAST:event_lblConsultaProductosMouseClicked
    ...
    FormCrearVenta fcv = new FormCrearVenta();
    fcv.setVisible(true);
    this.dispose();
    ...
    private void lblResumenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblResumenMouseClicked
        String[] options = {"Ventas", "Compras"};
        int x = JOptionPane.showOptionDialog(null, "Ver reporte de..",
            "Ventas - Compras",
...
//    }
    ...
    private javax.swing.JLabel lblImgVender4;
    ...
    private javax.swing.JLabel lblTituloVender4;
    ...
    private javax.swing.JLabel lblinfoVender4;
