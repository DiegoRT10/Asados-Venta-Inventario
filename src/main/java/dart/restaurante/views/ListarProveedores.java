...
public class ListarProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListarProveedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIT", "Nombre", "Direccion", "Telefono", "id"
            }
        ) {
        ...
        if (tblListarProveedores.getColumnModel().getColumnCount() > 0) {
            ...
            tblListarProveedores.getColumnModel().getColumn(3).setPreferredWidth(150);
            tblListarProveedores.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    for(Proveedor p : usuario){
        Object newRow[] = {p.getNit(),p.getNombre(),p.getDireccion(),p.getTelefono(),p.getId()};
        model.addRow(newRow);
    }   
        //Ocultar id
