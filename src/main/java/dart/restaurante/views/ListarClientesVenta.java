...
//import dart.restaurante.views.ListarProveedores.tblListarProveedores;
...
//        this.dispose();
    ...
    if(fila != -1){
    String idCliente = (String) tblListarProveedores.getValueAt(fila, 5);
    String nitCliente = (String) tblListarProveedores.getValueAt(fila, 0);
    String nombreCliente = (String) tblListarProveedores.getValueAt(fila, 1);
    ...
    List<Cliente> usuario = ClienteEntityManager.findClienteEntities();
    model.setRowCount(0); //eliminar filas existentes
    tblListarProveedores.setDefaultRenderer(Object.class, new Render());
    
    for(Cliente c : usuario){
        Object newRow[] = {c.getNit(),c.getNombre(),c.getNombre(),c.getDireccion(),c.getTelefono(),c.getId()};
        model.addRow(newRow);
    }   
        //Ocultar id
    ...
    String telefono = (String) tblListarProveedores.getValueAt(fila,3);
    String id = (String) tblListarProveedores.getValueAt(fila,4);
    
    FormEditarProveedor.setDatosProveedor(nit,nombre,direccion,telefono,id);
    }
